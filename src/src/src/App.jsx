...
/* PenKwacha — pen (writing) + kwacha (Zambian currency).
   Real accounts, real jobs, real bids — all stored in Supabase.
   Payment stays manual for now (client pays the admin directly via
   mobile money or crypto; admin releases to the writer on approval) —
   see the Wallet screen for how that works today. */
